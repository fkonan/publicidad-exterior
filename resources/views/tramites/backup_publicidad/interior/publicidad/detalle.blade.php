                            ...
                            @switch($solicitud->modalidad)
                                @case('VALLAS')
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        @if ($adjunto != null)
                                            @if ($adjunto->adj_concepto_planeacion != null)

                                                <td><strong>Concepto técnico planeación:</strong><br>
                                                    <a href="https://tramitesenlineapruebas.bucaramanga.gov.co/{{ $adjunto->adj_concepto_planeacion }}"
                                                        target="_blank">Descargar documento</a>&nbsp;&nbsp;<i
                                                        class="fa fa-download"></i>
                                                </td>
                                            @endif
                                        ...
                                        @if ($adjunto != null)
                                            ...
                                            @if ($adjunto->adj_concepto_salud != null)
                                                <td colspan="2"><strong>Concepto técnico salud:</strong><br>
                                                    <a href="https://tramitesenlineapruebas.bucaramanga.gov.co/{{ $adjunto->adj_concepto_salud }}"
                                                        target="_blank">Descargar documento</a>&nbsp;&nbsp;<i
                                                        class="fa fa-download"></i>
                                                </td>
                                            @else
                                    ...
                                    @if ($detalle->req_poliza != null || $detalle->req_tarjeta_profesional != null || $detalle->req_certi_civil != null)
                                        <tr style="background-color:#004884">
                                            <td colspan="3" style="background-color:#004884; color:white">Requisitos Finales
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        @if ($detalle->adj_RUT != '')
                                            <td><strong>RUT:</strong><br>
                                                <a href="/{{ $detalle->adj_RUT }}" target="_blank">Descargar
                                                    documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                                            </td>
                                        @endif
                                        @if ($detalle->adj_fotomontaje != '')
                            ...
                            <form method="POST" action="{{ route('interior.publicidad.update') }}"
                                            ...
                                            <select class="form-control  @error('estado_solicitud') is-invalid @enderror"
                                                ...
                                                @if ($solicitud->modalidad == 'VALLAS')
                                                    ...
                                                    @if ($solicitud->estado_solicitud == 'REQUISITOS-FINALES')
                                                        <option value="REQUISITOS-FINALES-PENDIENTES">
                                                            REQUISITOS-FINALES-PENDIENTES</option>
                                                ...
                                                @if ($solicitud->modalidad == 'PASACALLES')
                                                    @if ($solicitud->estado_solicitud == 'ENVIADA')
                                                        <option value="PENDIENTE">DOCUMENTOS PENDIENTES</option>
                                                        <option value="DOC-ACT-ADMINISTRATIVO">DOC-ACT-ADMINISTRATIVO
                                                        </option>
                                                        <option value="RECHAZADA">RECHAZADA</option>
                                                    @endif
                                                @endif

                                                @if ($solicitud->modalidad == 'PUBLICIDAD AEREA')
                                                    @if ($solicitud->estado_solicitud == 'ENVIADA')
                                                        <option value="PENDIENTE">DOCUMENTOS PENDIENTES</option>
                                                        <option value="REVISION-CONCEPTOS-SALUD">REVISION-CONCEPTOS
                                                        </option>
                                                        <option value="RECHAZADA">RECHAZADA</option>
                                                    @endif
                                                    @if ($solicitud->estado_solicitud == 'PENDIENTE' || $solicitud->estado_solicitud == 'DOC-ACT-CIUDADANO')
                                ...
                                <tr>
                                    @if ($solicitud->modalidad == 'PASACALLES')
                                        <td>
                                            <div class="form-group">
                                                <label for="adj_acto_administrativo">Cargar acto administrativo</label>
                                                <input type="file" accept="application/pdf" name="adj_acto_administrativo"
                                                    id="adj_acto_administrativo"
                                                    class="form-control @error('observaciones_solicitud') is-invalid @enderror">
                                                @error('adj_acto_administrativo')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong class="text-danger">{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                        ...
                                        <td>
                                            <label for="nombre_acto">Nombre o número del acto admin</label>
                                            <input type="text" class="form-control" id="nombre_acto" name="nombre_acto"
                                                value="{{ $solicitud->nombre_acto }}">
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <a href="{{ url('/tramites/interior/publicidad/PASACALLES') }}"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <button type="submit"
                                                    ...
                                                    class="btn btn-round btn-middle btn-outline-info btn_enviar_solicitud"
                                                    id="btnEstado">Actualizar estado</button>
                                                <a href="{{ url('/tramites/interior/publicidad/' . $solicitud->modalidad) }}"
                                                    class="btn btn-round btn-high">Volver</a>
