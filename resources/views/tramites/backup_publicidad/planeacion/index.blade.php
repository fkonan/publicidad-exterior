            ...
            <div class="row pt-5">
                ...
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card govco-card animate__animated animate__flipInX"
                        ...
                        <div class="card-body">
                            <p style="text-align: justify">Es la autorización previa para ocupar o para intervenir bienes de
                                uso público incluidos en el espacio público, de conformidad con las normas urbanísticas
                                adoptadas en el Plan de Ordenamiento Territorial, en los instrumentos que lo desarrollen y
                                complementen y demás normatividad vigente. </p>
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card govco-card animate__animated animate__flipInX"
                        ...
                        <div class="card-body">
                            <p style="text-align: justify">El objetivo del tramite es clasificar y categorizar los
                                parqueaderos públicos ubicados en el municipio de Bucaramanga, para su correcto
                                funcionamiento. Inicia con la solicitud del ciudadano hasta la expedición de la resolución
                                que otorga la categorización o modificación de categorización de los parqueaderos públicos
                                ubicados en el municipio de Bucaramanga. </p>
                        </div>
                        <div class="card-footer govco-card-footer govco-center">
                            <a class="btn-low-mix-govco align-column-govco"
                                href="{{ route('planeacion.parqueaderos.index') }}">
                                <span class="btn-mix-govco__title">Ver mas detalles</span>
                                <span class="btn-mix-govco__icon govco-icon govco-icon-simpled-arrow"></span>
                            </a>
                        </div>
