        ...
        <div class="container-fluid">
            <div class="row mt-2">
                ...
                <div class="alert-success-govco alert alert-dismissible fade show animate__animated animate__bounceInRight" aria-label="Alerta: caso de éxito">
                    ...
                    <p>Apreciado Ciudadano, su solicitud ha sido recibida satisfactoriamente para consultar el estado de sus solicitud tenga en cuenta el siguiente numero de radicado: <strong> {{$request->radicado}}</strong></p>
                  </div>
