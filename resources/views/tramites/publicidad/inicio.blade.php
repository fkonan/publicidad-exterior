               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <input value="{{ old('PersonaDoc') }}" type="text" required
                        class="form-control number_validate  @error('PersonaDoc') is-invalid @enderror"
                        name="PersonaDoc" id="PersonaDoc" maxlength="15" minlength="4" required
               ...
               <div id="divInfo" class="d-none">
                  <div class="row mb-3">
                     ...
                     <div class="col-md-4" id="natural_nombre">
                        ...
                        <input type="text"
                           class="form-control name_validate  @error('PersonaNombre') is-invalid @enderror"
                     ...
                     <div class="col-md-4" id="natural_ape">
                        ...
                        <input type="text"
                           ...
                           name="PersonaApe" id="PersonaApe" maxlength="25" minlength="4"
                           onkeypress="return Letras(event)" onkeyup="aMayusculas(this.value,this.id)">
                        @error('PersonaApe')
                        <span class="invalid-feedback" role="alert">
                           <strong class="text-danger">{{ $message }}</strong>
