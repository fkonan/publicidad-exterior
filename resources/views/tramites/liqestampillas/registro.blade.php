                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="" method="" role="form" id="myForm" enctype="multipart/form-data"
                        ...
                        <div class="row form-group mt-2">
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                <label for="LoEmail" class="form-label">Correo Electronico Responsable *
                                </label>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                <label for="LoNumActAdm" class="form-label">Numero acto administrativo * </label>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3 caja_nombreslo ">
                                <label for="LoEnti" class="form-label">Entidad en la cual se posesiona*
                                     </label>
                                <input value="{{ old('LoEnti') }}" type="text"
                                    class="form-control name_validate  @error('LoEnti') is-invalid @enderror"
                                    name="LoEnti" id="LoEnti" maxlength="25" minlength="4"
                                    onkeypress="return Letras(event)" onkeyup="aMayusculas(this.value,this.id)">
                                @error('LoEnti')
                                    <span class="invalid-feedback" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                <label for="archivo_acta_posesion" class="form-label">Acta de posesion* <br><small class="text-danger"
