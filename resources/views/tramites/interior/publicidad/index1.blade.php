									...
									<tbody>
										@foreach ($sEnviadas->datos as $solicitudesE)
											<tr>
												...
												<td>{{ $solicitudesE->nombre_responsable }} {{$solicitudesE->apellido_responsable}}</td>
												<td>{{ $solicitudesE->tipo_documento }}  {{ $solicitudesE->numero_documento }}</td>							
												...
												<td>
													<div class="btn-group" role="group">
														<a type="button" class="btn-symbolic-govco align-column-govco" href="{{route('interior.publicidad.detalle', $solicitudesE->id)}}">
